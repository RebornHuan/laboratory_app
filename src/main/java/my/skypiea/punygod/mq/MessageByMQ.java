...
public class MessageByMQ {
    ...
    static {
        ...
        MQEnvironment.hostname = "esbmqdev.cnsuning.com";            //MQ服务器的IP地址
        MQEnvironment.channel = "CHANNEL_DATALEGO";            //服务器连接的通道
        MQEnvironment.CCSID = 1381;                    //服务器MQ服务使用的编码1381代表GBK、1208代表UTF(Coded Character Set Identifier:CCSID)
        MQEnvironment.port = 1432;                        //MQ端口
        qmName = "OTHER_QM";                            //MQ的队列管理器名称
        qName = "MBF_syncSystemBD_DATALEGO";                                //MQ远程队列的名称
        try {
            //定义并初始化队列管理器对象并连接
